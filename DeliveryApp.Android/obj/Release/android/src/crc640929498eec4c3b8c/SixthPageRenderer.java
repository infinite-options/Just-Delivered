...
public class SixthPageRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeliveryApp.Droid.SixthPageRenderer, DeliveryApp.Android", SixthPageRenderer.class, __md_methods);
	}


	public SixthPageRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == SixthPageRenderer.class)
			mono.android.TypeManager.Activate ("DeliveryApp.Droid.SixthPageRenderer, DeliveryApp.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public SixthPageRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == SixthPageRenderer.class)
			mono.android.TypeManager.Activate ("DeliveryApp.Droid.SixthPageRenderer, DeliveryApp.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public SixthPageRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == SixthPageRenderer.class)
			mono.android.TypeManager.Activate ("DeliveryApp.Droid.SixthPageRenderer, DeliveryApp.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
