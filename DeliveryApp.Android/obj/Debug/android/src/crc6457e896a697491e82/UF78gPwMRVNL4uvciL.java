...
/** @hide */
	...
	public UF78gPwMRVNL4uvciL (android.content.Context p0, int p1)
	{
		super (p0, p1);
		if (getClass () == UF78gPwMRVNL4uvciL.class)
			mono.android.TypeManager.Activate ("nkSmBSsyJm4eISfkmt.UF78gPwMRVNL4uvciL, Leadtools.Camera.Xamarin.Android", "Android.Content.Context, Mono.Android:Android.Hardware.SensorDelay, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
